...
public static Melodia skyrim (){
	
			//youtube.com/watch?v=j8BAKpa4t9s
			
			new Melodias();
			
			frequencia = IntervalosMusicais.B(IntervalosMusicais.C1);
			...
			frequencia = IntervalosMusicais.E (IntervalosMusicais.C3);
			nota = new Nota (IntervalosMusicais.seminima(), frequencia, amplitudePadrao);
			melodiaPrincipal.addNota (nota);
		...
		public static Melodia fairytail (){
			
			//youtube.com/watch?v=GkOM4wJdBXs
